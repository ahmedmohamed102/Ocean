    ...
    <main className="overflow-x-hidden pt-24 lg:pt-28 antialiased">
      <div className="relative container">
        ...
        <section id="home" className="relative">
          ...
          <div className="flex flex-col items-center spacer-y-12">
            <div className="flex flex-col items-center spacer-y-12">
              <p className="capitalize border border-slate-700 py-1 px-3 text-xs rounded-3xl cursor-pointer hover:border-sky-500 Hover:bg-slate-800 shadow-md transition-all mb-8">
                new feature is now available
                <ArrowRightCircle className="inline ml-1 h-4" />
              </p>
              <Title title="A CRM dashboard for engineering teams" />
              <p className="max-w-[46rem] leading-normal sm:text-lg sm:leading-8 mb-8">
        ...
        >
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            <div className="flex flex-col gap-4 items-center text-center lg:items-start lg:text-start">
              <Title title="Powerful features to help you manage all your leads." />
        ...
        <section id="testimonials" className="flex flex-col gap-8">
          <Title title="Meet our Customers" isCentered />
        ...
        <section id="contact">
          <div className="bg-slate-800 rounded-lg px-8 lg:px-24 py-8 lg:py-12 flex flex-col lg:flex-row justify-between items-center gap-6">
            <div className="flex flex-col gap-4 text-center lg:text-start">
              <Title title="Let’s try our service now!" />
